...
class WorkspacesController(val manager: WorkspaceManager) {

    private val workspaceInstances: WorkspaceInstanceList = WorkspaceInstanceList(emptyList())
    ...
    private fun Route.install_() {
        ...
        modelixWorkspacesInstancesRoutes(object : ModelixWorkspacesInstancesController {
            ...
            override suspend fun listInstances(call: TypedApplicationCall<WorkspaceInstanceList>) {
                call.respondTyped(workspaceInstances)
            }
        })
